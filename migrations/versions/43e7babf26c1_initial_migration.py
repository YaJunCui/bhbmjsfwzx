...
Revision ID: 43e7babf26c1
Revises: 
Create Date: 2020-11-22 16:12:17.433004
...
def upgrade():
    ...
    sa.Column('date_year', sa.String(length=64), nullable=True),
    sa.Column('date_month', sa.String(length=64), nullable=True),
    sa.Column('date_day', sa.String(length=64), nullable=True),
